...
# Function to install additional packages for XFCE4
install_xfce4_i3_packages() {
    log "Installing additional packages for XFCE4+i3..."
    sudo apt install -y lightdm xfce4 xfce4-goodies arc-theme papirus-icon-theme gvfs gvfs-backends i3* dmenu suckless-tools feh lxappearance picom arc-theme papirus-icon-theme
}
