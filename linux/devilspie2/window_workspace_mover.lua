...
assign_to_workspace("masterpdfeditor5", 3)
...
assign_to_workspace("mqtt-explorer", 4)
...
assign_to_workspace("VirtualBox", 8)
assign_to_workspace("STM32CubeIDE", 9)
assign_to_workspace("jetbrains-studio", 9)
assign_to_workspace("STM32CubeProgrammer", 9)
assign_to_workspace("STM32TrustedPackageCreator", 9)
